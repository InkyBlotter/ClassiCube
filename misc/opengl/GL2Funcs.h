...
/* Framebuffer object functions (GL 3.0 / GL_ARB_framebuffer_object) */
GL_FUNC(void, glGenFramebuffers, (GLsizei n, GLuint* ids))
GL_FUNC(void, glDeleteFramebuffers, (GLsizei n, const GLuint* ids))
...
GL_FUNC(void, glGenRenderbuffers, (GLsizei n, GLuint* ids))
GL_FUNC(void, glDeleteRenderbuffers, (GLsizei n, const GLuint* ids))
